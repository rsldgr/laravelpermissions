...
@section('content')
        ...
        <div class="row">
                <div class="col-md-8">
                    <div class="card-box">
                        <h4 class="mt-0 mb-3 header-title">{{ __('Create New Role') }}</h4>
                        ...
                        <form role="form" method="POST" action="{{ route('admin.roles.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <small id="nameHelp" class="form-text text-muted">{{ __('Role Kullanım Adını Giriniz : article-edit gibi') }}</small>
                            </div>
                            <div class="form-group">
